...
namespace TSSPruebaInventario.Controllers
{
    public class UbicacionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Descripcion,IDProductoUbicacion")] Ubicacion ubicacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Descripcion,IDProductoUbicacion")] Ubicacion ubicacion)
        {
            if (ModelState.IsValid)
            {
